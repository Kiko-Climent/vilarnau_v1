  ...
  return (
    <motion.div style={{scale, rotate}} className="sticky top-0 h-screen bg-[white] text-[3.5vw] flex flex-col items-center justify-center text-white pb-[10vh]">
      <div className="relative flex items-center justify-center">
        ...
        <img src="/images/Vilarnau x Palma Llopis-12.jpg"
            className="relative flex px-8 object-contain h-screen"/>
          <p className="absolute flex text-5xl md:text-7xl font-bold text-white inset-0 items-center justify-center blur-[0.5px] opacity-70">works</p>
